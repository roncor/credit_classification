...
def main():
    ...
    st.set_page_config(page_title="Data Analysis with Python - Group 4", page_icon="📊")
    st.markdown(
        """
        <style>
        .title {
    ...
    st.markdown("<h2 class='title'>Group 4</h2>", unsafe_allow_html=True)
    st.write("Welcome to our data analysis project!")
